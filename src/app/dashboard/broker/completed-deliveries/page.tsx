...
import { CheckCircle, Package, Clock, MapPin, DollarSign, Calendar } from 'lucide-react'
                    ...
                    <CardContent className="pt-6">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-2xl font-bold text-gray-900">
                                    {deliveries.filter(d => !d.paymentReceived).length}
                                </p>
                            </div>
                ...
                <Card>
                    <CardContent className="pt-6">
                        <div className="text-center py-12">
                            ...
                            <h3 className="text-lg font-medium text-gray-900 mb-2">Tamamlanmış Teslimat Yok</h3>
                            <p className="text-gray-600">Henüz tamamlanmış teslimat bulunmuyor.</p>
                        </div>
                    </CardContent>
                </Card>
            ) : (
                            ...
                            <CardContent className="space-y-4">
                                        ...
                                        <div className="grid grid-cols-2 gap-4 text-sm">
                                            ...
                                            {delivery.vehicleInfo && (
                                                <div>
                                                    ...
                                                    <p className="font-medium">{delivery.vehicleInfo.plateNumber || '-'}</p>
                                                </div>
                                            )}
                                        </div>
                                    </div>
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                                    <div>
                                        ...
                                        <p className="font-medium">{formatDate(delivery.pickupTime)}</p>
                                    </div>
                                    <div>
                                        <span className="text-gray-600 flex items-center gap-1">
                                        ...
                                        <p className="font-medium">{formatDate(delivery.deliveryTime)}</p>
                                    </div>
                                    {delivery.brokerInfo?.commissionAmount && (
                                        <div>
                                            ...
                                            <p className="font-medium">{formatCurrency(delivery.brokerInfo.commissionAmount)}</p>
                                        </div>
                                    )}
                                    {delivery.completedDate && (
                                        <div>
                                            ...
                                            <p className="font-medium">{formatDate(delivery.completedDate)}</p>
                                        </div>
                                    )}
                                </div>
