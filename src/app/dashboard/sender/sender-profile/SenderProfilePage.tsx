...
export default function SenderProfilePage() {
    ...
    // Linked account kontrolü
    const isLinkedAccount = user?.isLinkedAccount || false;
        ...
        <div className="container mx-auto py-8 px-4 max-w-4xl relative">
            ...
            {isLinkedAccount && (
                <div className="absolute inset-0 z-50 bg-white/95 backdrop-blur-sm flex items-center justify-center">
                    <div className="max-w-md mx-auto p-8 bg-white rounded-lg shadow-2xl border-2 border-orange-500">
                        <div className="text-center">
                            ...
                            <p className="text-gray-600 mb-2">
                                Bağlı hesap ile giriş yaptınız:
                            </p>
                            <p className="text-orange-600 font-semibold mb-4">
                                {user?.loginEmail}
                            </p>
                            <p className="text-gray-700 mb-6">
                                Profil yönetimi sadece ana hesap (<span className="font-semibold">{user?.email}</span>) ile yapılabilir.
                            </p>
                            <div className="bg-orange-50 p-4 rounded-lg border border-orange-200">
                                <p className="text-sm text-gray-700">
                                    <strong>İpucu:</strong> Çıkış yapıp ana hesabınız ile giriş yaparak profil ayarlarınızı yönetebilirsiniz.
                                </p>
                            </div>
                        </div>
                    </div>
